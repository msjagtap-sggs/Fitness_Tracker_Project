	...
	return (
		<aside className='flex'>
			<div className='flex flex-col items-center w-16 h-screen py-8 bg-white dark:bg-gray-900 dark:border-gray-700'>
				<nav className='flex flex-col items-center flex-1 space-y-8 '>
					...
					<Link
						to='/home'
						className='p-1.5 inline-block text-gray-500 focus:outline-none transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100'
						id='home'>
						<svg
        ...
        <Link
          ...
          aria-label='Open notifications'>
					...
					<Link
						to={userID ? `/settings?tab=general&userID=${userID}` : "/settings?tab=general"}
			...
			<div className='h-screen px-5 py-8 overflow-y-auto bg-white border-l border-r sm:w-64 w-60 dark:bg-gray-900 dark:border-gray-700'>
				...
				<nav className='mt-4 -mx-3 space-y-6 '>
					...
					<div className='space-y-3 '>
						...
						<Link
							className='flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700'
							to={userID ? `/guides?userID=${userID}` : "/guides"}>
							<svg
								xmlns='http://www.w3.org/2000/svg'
								fill='none'
								viewBox='0 0 24 24'
						...
						<Link
							className='flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700'
							to={userID ? `/hotspots?userID=${userID}` : "/hotspots"}>
							<svg
								xmlns='http://www.w3.org/2000/svg'
								fill='none'
								viewBox='0 0 24 24'
					...
					<div className='space-y-3 '>
						...
						<Link
							className='flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700'
							to={userID ? `/settings?tab=theme&userID=${userID}` : "/settings?tab=theme"}>
							<svg
								xmlns='http://www.w3.org/2000/svg'
								fill='none'
								viewBox='0 0 24 24'
